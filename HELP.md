...
* The original package name 'dev.dmitriy.job-x-hunter' is invalid and this project uses 'dev.dmitriy.job_x_hunter' instead.
...
* [Quartz Scheduler](https://docs.spring.io/spring-boot/3.5.14/reference/io/quartz.html)
